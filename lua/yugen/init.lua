...
function M.colorscheme()
	...
	if config.colors.primary then
		palette.primary = config.colors.primary
	end
	if config.colors.success then
		palette.success = config.colors.success
	end
	if config.colors.warning then
		palette.warning = config.colors.warning
	end
